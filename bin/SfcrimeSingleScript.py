# this is same script as sfcrime.py, all the required functions are defined in a single file for submission to kaggle.
...
##################################### Build the model ####################################
# Split data in to training and intermediate set
